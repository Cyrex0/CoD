...
#define Protect() VMProtectBeginUltra(__FUNCTION__)
#define ProtectEnd() VMProtectEnd()

//#define Protect()
//#define End()

//const char* EncryptVmprot(const char* text);
//const wchar_t* EncryptVmprot(const wchar_t* text);

#define E(str) VMProtectDecryptStringA(str)
#define EW(str) VMProtectDecryptStringW(str)
